$.fn.draggable = function (opt) {
    var base = this;
    var settings = {handle: "", cursor: "move", axis: null, containParent: false};
    ...
    return $el.css('cursor', opt.cursor).on("mousedown", function (e) {
        ...
        var z_idx = $drag.css('z-index'), drg_h = $drag.outerHeight(), drg_w = $drag.outerWidth(),
            pos_y = $drag.offset().top + drg_h - e.pageY, pos_x = $drag.offset().left + drg_w - e.pageX;
        var parent = $(this).parent();
        var parW = parent.width(), parH = parent.height();
        ...
        $drag.css('z-index', 1000).parents().on("mousemove", function (e) {
            var off_top = e.pageY + pos_y - drg_h, off_left = e.pageX + pos_x - drg_w, offst = null;
            ...
            if (opt.axis == "x") {
                ...
                offst = {left: off_left, top: off_top};
            }
